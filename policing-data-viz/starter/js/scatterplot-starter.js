...
function drawDots(race, rate_type, svg, x, y, max_rate) {
  ...
  dots.enter()
    .append("circle")
      ...
      .attr("r", function(d) {
          /* BEGIN CODE */
          // The radius of the dot should be proportional to the fraction of 
          // the selected minority stops of total stops
          return 3;
          /* END CODE */
        })
...
function focusDots(state, race, rate_type) {
  ...
  // BEGIN CODE
  // Focus all dots of the given state and race and rate type
  // END CODE
};
